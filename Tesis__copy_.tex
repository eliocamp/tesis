...
\begin{figure*}
\includegraphics[width=155mm, ]{fig/tesis/qs3sd-ncep-1} \caption{Desvío estándar temporal de Z* reconstruida a partir de la QS3. Se incluyen en negro los contornos de $\pm$ 20mgp de la amplitud de Fourier para indicar la posición de los centros de las perturbaciones (NCEP).}\label{fig:qs3sd-ncep}
\end{figure*}
