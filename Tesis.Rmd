...
```{r waveletz-ncep, fig.cap = "Campo medio de la amplitud de la onda 3 según wavelets (contornos) y su anomalía zonal (sombreado) en 300hPa.", fig.subcap = c("Haciendo la amplitud del campo medio", "Haciendo el valor medio de la amplitud."), fig.class = "fullpage", fig.ncol = 1}
...
Southern mid- to high-latitude variability, a zonal wavenumber-3 pattern, and the Antarctic circumpolar wave in the CSIRO coupled model tiene un índce similar al de Marilyn
