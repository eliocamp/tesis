...
En la \autoref{fig:u-sp-nc-corte} se muestra el viento zonal para SPEEDY y NCEP. El jet subtropical se encuentra más al norte y ligéramente más elevado en verano, así como considerablemente más intenso en todas las estaciones. La falta de niveles verticales se hace evidente en la falta de un jet polar. 
...
rbind(ncep.mean.season[lev == 300, .(lon, lat, lev, season, k, k.full)][lon %~% 180][, mod := "NCEP"], 
