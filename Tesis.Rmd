...
```{r wavelet-ejemplo, fig.show = "hold", fig.env = "figure*", fig.height = 70/25.4, fig.cap = "Wavelets", fig.class = "halfpage", fig.subcap = c("Campo", "Análisis de Wavelets en círculos de latitud señalados.")}
...
```{r gh-ncep, fig.class = "fullpage", fig.cap = "Altura geopotencial."}
