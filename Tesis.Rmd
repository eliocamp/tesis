...
rect.annotation <- data.frame(latmin = -65, latmax = -40,
                              ...
                              k = 3)
ncep.qs2 <- ncep.mean.season[, FitQsWave(gh, k = 1:4), 
                             by = .(lat, lev, season)] 
binwidth <- 0.1
ggplot(ncep.qs2, aes(lat, lev)) +
