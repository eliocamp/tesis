...
{\centering \subfloat[Discribución\label{fig:max_mean_compara1}]{\includegraphics[width=130mm]{fig/tesis/max_mean_compara-1} }\newline\subfloat[Corte vertical.\label{fig:max_mean_compara2}]{\includegraphics[width=130mm]{fig/tesis/max_mean_compara-2} }
