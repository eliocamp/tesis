...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/v_anomal_ncep-1} 
...
{\centering \includegraphics[width=130mm, ]{fig/tesis/r2_qs_ncep-1} 
...
{\centering \includegraphics[width=130mm, ]{fig/tesis/ampl_qs_ncep-1} 
...
\begin{figure*}
\includegraphics[width=150mm, ]{fig/tesis/qs_teorico_sd_corte_ncep-1} \caption{Corte sd}\label{fig:qs_teorico_sd_corte_ncep}
\end{figure*}
...
\begin{figure*}
\subfloat[Discribución\label{fig:max_mean_compara1}]{\includegraphics[width=150mm, ]{fig/tesis/max_mean_compara-1} }\newline\subfloat[Corte vertical.\label{fig:max_mean_compara2}]{\includegraphics[width=150mm, ]{fig/tesis/max_mean_compara-2} }\caption{Distribució de amplitud para 12 fechas. En rojo la amplitud máxima, en azul la amplitud media.}\label{fig:max_mean_compara}
\end{figure*}
...
\begin{figure}
\centering
\includegraphics{fig/tesis/r2_visual-1.pdf}
\caption{R2 medio}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{fig/tesis/tabla_interaccion-1.pdf}
\caption{Tabla de interacción}
\end{figure}
...
\caption{Composición según R2 medio}\label{fig:comp-r2}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/comp-cor-1} 

}

\caption{Composición según R2 Reconstruido}\label{fig:comp-cor}
\end{figure}
