...
\begin{figure}
\centering
\includegraphics{fig/tesis/k-steady-1.pdf}
...
\begin{figure}
\centering
\includegraphics{fig/tesis/ampl-fase-1.pdf}
\caption{Amplitud y fase media para cada mes.}
\end{figure}

Otro ejemplo podría usar SVD:

\includegraphics{fig/tesis/index-eof-1.pdf}
\includegraphics{fig/tesis/index-eof-2.pdf}
\includegraphics{fig/tesis/index-eof-3.pdf}
\includegraphics{fig/tesis/index-eof-4.pdf}
...
\begin{figure}
\centering
\includegraphics{fig/tesis/cros-cor-1.pdf}
\caption{Matriz de Correlación del campo de QS3.}
\end{figure}
...
\includegraphics{fig/tesis/cor-field-1.pdf}
\includegraphics{fig/tesis/cor-field-2.pdf}

\begin{figure}
\centering
\includegraphics{fig/tesis/cor-monson-1.pdf}
\caption{Correlación cuadrada media para estaciones según Monsón de
Sudamérica.}
\end{figure}
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/eof-comp-1} 

}

\caption{Campos EOF para cada mes (probablemente basura)}\label{fig:eof-comp}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{fig/tesis/sam-ampl-1.pdf}
\caption{Relación entre amplitud media de la onda 3 y el SAM}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{fig/tesis/fase-mal-1.pdf}
...
\begin{figure}
\centering
\includegraphics{fig/tesis/boxplot-fase-ncep-1.pdf}
\caption{Ciclo anual de la fase (20 mayores amplitudes para cada mes)}
\end{figure}

\begin{figure}
\centering
\includegraphics{fig/tesis/boxplot-fase-ncep2-1.pdf}
