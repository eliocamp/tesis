...
\begin{figure*}
\includegraphics[width=150mm, ]{fig/tesis/qs3-sp-nc-1} \caption{Media de reconstrucción de onda 3 (sombreado speedy, contornos ncep) - fig:qs3-sp-nc}\label{fig:qs3-sp-nc}
\end{figure*}
...
\begin{figure*}
\includegraphics[width=150mm, ]{fig/tesis/ghz-dif-sp-runs-1} \caption{Diferencia Corrida - control para Z* - fig:ghz-dif-sp-runs}\label{fig:ghz-dif-sp-runs}
\end{figure*}
...
{\centering \includegraphics[width=227mm,]{fig/tesis/u-dif-sp-runs-1} 
