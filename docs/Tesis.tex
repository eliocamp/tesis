...
\begin{figure}
\includegraphics[ ]{fig/tesis/k-steady-ncep-1} \caption{Número de onda estacionario en 300hPa.}\label{fig:k-steady-ncep}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=130mm, ]{fig/tesis/ks-lat-ncep-1} 
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/psi_ncep-1} 
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/wavelet_medio_anom-1} 
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/wavelet_corte-1} 
...
{\centering \includegraphics[width=150mm, ]{fig/tesis/psi-reg-1} 
...
\begin{figure}
\includegraphics[ ]{fig/tesis/sp-nc-regr-1} \caption{Correlación lineal entre campos de SPEEDY y NCEP.}\label{fig:sp-nc-regr}
\end{figure}
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/sp-nc-gh-1} 

}

\caption{Altura geopotencial (speedy contornos con color, ncep contornos grises)}\label{fig:sp-nc-gh}
\end{figure}
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/sp-nc-gh.z-1} 
...
Veredicto:\\
* Agarra bien la estructura media. Localización e intensidad del los
gradientes y su variación con la altura. * Agarra bien la anomalía zonal
aunque con magnitud menor.

\begin{figure}

{\centering \includegraphics[width=130mm, ]{fig/tesis/sp-nc-gh.65-1} 
...
{\centering \includegraphics[width=130mm, ]{fig/tesis/sp-nc-u-corte-1} 

}

\caption{Viento zonal medio.}\label{fig:sp-nc-u-corte}
\end{figure}
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/u_medio_sp-1} 

}

\caption{Viento zonal.}\label{fig:u_medio_sp}
\end{figure}
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/u_nomalia_sp-1} 

}

\caption{Anomalía zonal de viento zonal.}\label{fig:u_nomalia_sp}
\end{figure}
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/eta-dy-sp-nc-1} 

}

\caption{Gradiente meridional de vorticidad absoluta.}\label{fig:eta-dy-sp-nc}
\end{figure}
...
\begin{figure}
\includegraphics[ ]{fig/tesis/k-steady-sp-1} \caption{Número de onda estacionario en 300hPa.}\label{fig:k-steady-sp}
\end{figure}
...
{\centering \includegraphics[width=130mm, ]{fig/tesis/ks-lat-sp-1} 
...
\begin{figure*}
\includegraphics[width=150mm, ]{fig/tesis/ampl-comp-1} \caption{Ampllitud de Fourier (speedy en sombreado, ncep en contornos).}\label{fig:ampl-comp}
\end{figure*}

\begin{figure*}
\includegraphics[width=150mm, ]{fig/tesis/qs-comp-1} \caption{Media de reconstrucción de onda 3 (sombreado speedy, contornos ncep)}\label{fig:qs-comp}
\end{figure*}
...
\begin{figure}
\includegraphics[ ]{fig/tesis/ampl-corridas-1} \caption{Amplitud media de la onda 3 para cada corrida.}\label{fig:ampl-corridas}
\end{figure}

\begin{figure}
\includegraphics[ ]{fig/tesis/control-run-1} \caption{Diferencia de amplitud entre la corrida control y cada corrida.}\label{fig:control-run}
\end{figure}

\begin{figure}
\includegraphics[ ]{fig/tesis/sp-ciclo-anual-1} \caption{Ciclo anual de amplitud de onda 3.}\label{fig:sp-ciclo-anual}
\end{figure}
