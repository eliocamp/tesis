...
\begin{figure*}
\includegraphics[width=155mm, ]{fig/tesis/estacionaridad-1} \caption{Razón entre la de amplitud de la media estacional y media de la amplitud.}\label{fig:estacionaridad}
\end{figure*}
