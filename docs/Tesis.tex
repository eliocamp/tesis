...
\begin{figure}
\includegraphics[ ]{fig/tesis/cros-cor-1} \caption{Matriz de Correlación del campo de QS3.}\label{fig:cros-cor}
\end{figure}
...
\begin{figure}
\subfloat[Anomalía zonal\label{fig:cor-field1}]{\includegraphics[ ]{fig/tesis/cor-field-1} }\newline\subfloat[Campo total\label{fig:cor-field2}]{\includegraphics[ ]{fig/tesis/cor-field-2} }\caption{Correlación cuadrada media para estaciones según onda3.}\label{fig:cor-field}
\end{figure}

\begin{figure}
\includegraphics[ ]{fig/tesis/cor-monson-1} \caption{Correlación cuadrada media para estaciones según Monsón de Sudamérica.}\label{fig:cor-monson}
\end{figure}
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/eof-comp1-1} 

}

\caption{Campos EOF para cada mes (probablemente basura)}\label{fig:eof-comp1}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/eof-comp2-1} 

}

\caption{Campos EOF para cada mes (probablemente basura)}\label{fig:eof-comp2}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/eof-comp3-1} 

}

\caption{Campos EOF para cada mes (probablemente basura)}\label{fig:eof-comp3}
\end{figure}
...
\begin{figure}
\includegraphics[ ]{fig/tesis/boxplot-fase-ncep2-1} \caption{Ciclo anual de la fase (todos)}\label{fig:boxplot-fase-ncep2}
\end{figure}
