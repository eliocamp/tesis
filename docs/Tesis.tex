...
\caption{Anomalía zonal de viento zonal (speedy).}\label{fig:u_nomalia_sp}
\end{figure}
...
\begin{figure}
\includegraphics[ ]{fig/tesis/k-steady-sp-1} \caption{Número de onda estacionario en 300hPa (speedy).}\label{fig:k-steady-sp}
\end{figure}
...
\begin{figure}
\includegraphics[ ]{fig/tesis/sd-val-1} \caption{Desvío estándar medio para SST y LST.}\label{fig:sd-val}
\end{figure}
