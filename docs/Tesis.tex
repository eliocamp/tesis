...
invierno y primavera, los niveles altos están dominados por una onda 1
con máximo en el sur de Autralia y mínimo en el Atlántico sur. En
niveles más bajos, la onda se defasa hacia el este y queda casi en
cuadratura (\autoref{fig:tz-ncep-corte60}) con el máximo en 850hPa en
...
\begin{figure}
\includegraphics[ ]{fig/tesis/ghminus1-ncep-1} \caption{Z* menos onda 1. - fig:ghminus1-ncep - SÓLO BORRADOR}\label{fig:ghminus1-ncep}
\end{figure}
