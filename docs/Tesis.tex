...
\begin{figure}
\subfloat[Haciendo la amplitud del campo medio\label{fig:waveletz-ncep1}]{\includegraphics[ ]{fig/tesis/waveletz-ncep-1} }\newline\subfloat[Haciendo el valor medio de la amplitud.\label{fig:waveletz-ncep2}]{\includegraphics[ ]{fig/tesis/waveletz-ncep-2} }\caption{Campo medio de la amplitud de la onda 3 según wavelets (contornos) y su anomalía zonal (sombreado) en 300hPa. - fig:waveletz-ncep}\label{fig:waveletz-ncep}
\end{figure}
...
\begin{figure}
\includegraphics[ ]{fig/tesis/sam-ampl-1} \caption{Relación entre amplitud media de la onda 3 y el SAM - fig:sam-ampl - SÓLO BORRADOR}\label{fig:sam-ampl}
\end{figure}
...
{\centering \includegraphics[width=227mm,angle=90]{fig/tesis/regr-olr-ncep-1} 
