...
```{r, fig.fullwitdh = TRUE, fig.cap = "Función corriente original en sombreado, función corriente a partir de invertir el laplaciano en contornos."}
sp[!is.na(zeta), psi.inv := InverseLaplacian(zeta, lon*pi/180, lat*pi/180)]
