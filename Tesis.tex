...
{\centering \subfloat[DEF\label{fig:psi-regr-runs1}]{\includegraphics[width=247mm,]{fig/tesis/psi-regr-runs-1} }\newline\subfloat[MAM\label{fig:psi-regr-runs2}]{\includegraphics[width=247mm,]{fig/tesis/psi-regr-runs-2} }\newline\subfloat[JJA\label{fig:psi-regr-runs3}]{\includegraphics[width=247mm,]{fig/tesis/psi-regr-runs-3} }\newline\subfloat[SON\label{fig:psi-regr-runs4}]{\includegraphics[width=247mm,]{fig/tesis/psi-regr-runs-4} }\newline\subfloat[DEF\label{fig:psi-regr-runs5}]{\includegraphics[width=247mm,]{fig/tesis/psi-regr-runs-5} }\newline\subfloat[MAM\label{fig:psi-regr-runs6}]{\includegraphics[width=247mm,]{fig/tesis/psi-regr-runs-6} }\newline\subfloat[JJA\label{fig:psi-regr-runs7}]{\includegraphics[width=247mm,]{fig/tesis/psi-regr-runs-7} }\newline\subfloat[SON\label{fig:psi-regr-runs8}]{\includegraphics[width=247mm,]{fig/tesis/psi-regr-runs-8} }

}

\caption{Regresión de psi con la amplitud de la QS3. - fig:psi-regr-runs}\label{fig:psi-regr-runs}
\end{figure}
\end{landscape}
